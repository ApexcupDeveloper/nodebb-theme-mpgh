...
define('mpgh/quickreply', ['components', 'composer/autocomplete'], function(components, autocomplete) {
	var QuickReply = {};
	...
	QuickReply.init = function() {
		...
		autocomplete._active['mpgh_qr'] = autocomplete.setup(data);
		...
		components.get('topic/quickreply/button').on('click', function(e) {
			...
			socket.emit('posts.reply', replyData, function(err, data) {
				...
				autocomplete._active['mpgh_qr'].hide();
			});
		});
	};
